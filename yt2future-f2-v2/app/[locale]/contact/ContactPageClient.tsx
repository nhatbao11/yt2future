      ...
      <main className="grow py-7 md:py-12 lg:py-16">
        <div className="max-w-360 mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div className="space-y-12 flex flex-col justify-between">
              <div>
                <h2 className="text-4xl md:text-5xl font-black text-[#001a41] uppercase tracking-tighter mb-6">
                  {t('getInTouch')}{' '}
                  <span className="text-yellow-500">{t('getInTouchHighlight')}</span>
                </h2>
            ...
            <div className="w-full h-full min-h-[400px] bg-gray-100 rounded-sm overflow-hidden border border-yellow-500 shadow-2xl">
              <iframe
