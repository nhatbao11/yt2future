  ...
  const businessReports = [
    {
      ...
      description:
        'Phân tích cấu trúc tài chính và tiềm năng bứt phá của hệ sinh thái Vingroup trong kỷ nguyên xanh.',
    ...
    // ... other items kept static for now as mock data
    {
      ...
      description:
        'Đánh giá mô hình heo ăn chuối và khả năng xử lý nợ vay của bầu Đức trong chu kỳ mới.',
    ...
    },
    {
      ...
      description:
        'Phân tích chất lượng tài sản và triển vọng tăng trưởng lợi nhuận sau trích lập dự phòng.',
      ...
      <main className="max-w-360 mx-auto px-6 md:px-12 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {businessReports.map((report) => (
            <div
              key={report.id}
              className="group bg-white border border-gray-100 flex flex-col md:flex-row overflow-hidden hover:shadow-xl transition-all duration-500"
            >
              {/* Ticker & Image */}
              ...
              <div className="md:w-3/5 p-8 flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="flex items-center gap-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                    ...
                    <span className="flex items-center gap-1 text-yellow-500">
                      <Briefcase size={12} /> {report.category}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-gray-50">
                    ...
                    <div>
                      <p className="text-[10px] font-black text-[#001a41] uppercase">
                        {t('by')} {report.author}
                      </p>
                ...
                <div className="flex gap-3 mt-8">
                  <Link
                    href="#"
                    className="flex-1 bg-[#001a41] text-white text-[10px] font-black uppercase tracking-widest py-3 text-center hover:bg-yellow-500 transition-colors flex items-center justify-center gap-2"
                  >
