...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description =
    locale === 'vi'
      ? 'Chương trình đào tạo ACCA thực chiến chất lượng cao tại YT2Future. Học chủ động cùng chuyên gia Big 4.'
      : 'High-quality ACCA practical training programs at YT2Future. Learn actively with Big 4 experts.';
