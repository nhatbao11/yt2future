  ...
  return (
    <div className="flex flex-col items-center gap-4 mb-6">
      <div className="relative group">
        <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-2xl ring-2 ring-yellow-500/20">
          <Image
            src={preview}
            alt="Avatar"
            fill
        ...
        <label
          ...
          className="absolute bottom-1 right-1 bg-yellow-500 p-2 rounded-full text-white cursor-pointer border-2 border-white"
        >
          <Camera size={18} />
        </label>
      </div>
