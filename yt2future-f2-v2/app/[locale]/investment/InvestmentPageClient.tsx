    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <main className="max-w-360 mx-auto px-6 md:px-12 py-20 md:py-20 flex flex-col items-center justify-start text-center">
        ...
        <div className="mt-16">
          <Link
            href="/"
            className="group flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.4em] text-[#001a41] hover:text-yellow-600 transition-all border-b-2 border-transparent hover:border-yellow-600 pb-1"
          >
