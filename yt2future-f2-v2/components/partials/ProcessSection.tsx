      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-12 justify-between relative">
        ...
        {steps.map((step, i) => (
          <ScrollReveal
            key={i}
            delay={i * 0.2}
            className="relative group flex flex-row lg:flex-col items-start lg:items-center gap-6 lg:gap-10 flex-1 z-10"
          >
            ...
            <div className="relative z-10 shrink-0">
              <div
                className="w-14 h-14 lg:w-24 lg:h-24 bg-[#001a41] text-yellow-500 flex items-center justify-center 
            ...
            <div className="relative z-10 lg:text-center space-y-4 pt-2 lg:pt-0">
              <div className="flex items-center lg:justify-center gap-2">
                <span className="text-yellow-500 text-xl lg:text-lg tracking-[0.3em] font-black">
                  0{i + 1}.
                </span>
