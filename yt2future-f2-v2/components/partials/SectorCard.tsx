...
export default function SectorCard({ title, desc, icon: Icon }: SectorProps) {
  return (
    <>
      <div className="group relative p-10 border border-gray-100 transition-all duration-500 flex flex-col items-start overflow-hidden sector-card h-full justify-between">
        {/* Icon lớn mờ ở góc */}
